...
<html lang="it">
	...
	<head>
		...
		<link href="/MicheleProject/application/img/michele.jpg" rel="apple-touch-icon">
		
		<!-- Google Fonts -->
		<link href="/MicheleProject/components/css/fonts.googleapis.com.css" rel="stylesheet">
		
		<!-- Vendor CSS Files -->
		<link href="/MicheleProject/components/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
		<link href="/MicheleProject/components/vendor/icofont/icofont.min.css" rel="stylesheet">
		<link href="/MicheleProject/components/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
		<link href="/MicheleProject/components/vendor/venobox/venobox.css" rel="stylesheet">
		<link href="/MicheleProject/components/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">
		<link href="/MicheleProject/components/vendor/aos/aos.css" rel="stylesheet">
	...
	<body>
					...
					<div class="container">
							...
							<div class="row">
								...
								<div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
									...
									<div class="row">
										<div class="col-lg-7">
											<ul>
												...
												<strong>Nato:</strong> il 18 febbraio 1952</li>
												<li><i class="icofont-rounded-right"></i> 
												<strong>Site web:</strong> www.poetipoesia.com/michele-lalla</li>
											</ul>
										</div>
										<div class="col-lg-5">
											<ul>
									...
									<c:forEach var="opera" items="${opere}">
										<ul><li> <i class="icofont-rounded-right"></i> 
											<strong>In ${opera.data}:</strong> ${opera.descrizione}</li></ul> 
									</c:forEach>
								</div>
							</div>
						</c:if>
						...
						<c:if test="${not empty pageContext.request.remoteUser}">
							<div class="row">
								...
								<div class="col-lg-2">
									<button type="button" data-toggle="modal" data-target="#popInsertOpera" class="button">Inserisci</button>
								</div>
								<!-- <c:if test="${not empty pageContext.request.remoteUser}"> -->
											...
											<c:forEach var="opera" items="${opere}">
												<tr>
													<td style="width:100px;">
														<div ><ul><li> <i class="icofont-rounded-right"></i> 
															<strong>In ${opera.data}:</strong></li></ul> </div>
													</td>
						...
						<div class="row">
							...
							<c:if test="${not empty pageContext.request.remoteUser}">
								<div class="col-lg-2">
									<button type="button" data-toggle="modal" data-target="#popInsertPremiazione" class="button">Inserisci</button>
								</div>
							</c:if>
						...
						<c:forEach var="item" items="${premiazioni}">
							...
							%>
							<div class="row">
								<div class="col-lg-4 col-md-6 portfolio-item filter-app" data-aos="fade-up" data-aos-delay="100">
									...
									<div class="modal-body">
								        ...
								        <div class="row" data-aos="fade-in">
								          <div class="col-lg-12"> <!-- action="${url}" method="POST" -->
												...
												<div class="form-group">
													<label for="Anno">Città:</label> 
													<input type="text"
														class="form-control" id="cittaPremiazioe"
														data-rule="minlen:4" placeholder="Citta" data-msg="Inserisci la città per favore" />
													<div class="validate"></div>
												</div>
												<div class="form-group">
													<label for="Descrizione">Descrizione:</label>
													<textarea class="form-control" rows="10" id="descrizionePremiazioe"
														data-rule="required" placeholder="Descrizione" data-msg="Inserisci la descrizione per favore"></textarea>
													<div class="validate"></div>
												</div>
												<div id="result"></div>
								        ...
								        <div class="row" data-aos="fade-in">
								          <div class="col-lg-12"> <!-- action="${url}" method="POST" -->
												<div class="form-group">
													<label for="Anno">Anno:</label> 
													<input type="text"
														class="form-control" id="annoOpera"
														data-rule="minlen:4" placeholder="Anno" data-msg="Inserisci l'anno per favore" />
													<div class="validate"></div>
												</div>
												<div class="form-group">
													<label for="Descrizione">Descrizione:</label>
													<textarea class="form-control" rows="10" id="descrizioneOpera"
														data-rule="required" placeholder="Descrizione" data-msg="Inserisci la descrizione per favore"></textarea>
													<div class="validate"></div>
												</div>
												<div id="result"></div>
		...
		<script src="/MicheleProject/components/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
		<script src="/MicheleProject/components/vendor/jquery.easing/jquery.easing.min.js"></script>
		<script src="/MicheleProject/components/vendor/php-email-form/validate.js"></script>
		<script src="/MicheleProject/components/vendor/waypoints/jquery.waypoints.min.js"></script>
		<script src="/MicheleProject/components/vendor/counterup/counterup.min.js"></script>
		<script src="/MicheleProject/components/vendor/isotope-layout/isotope.pkgd.min.js"></script>
		<script src="/MicheleProject/components/vendor/venobox/venobox.min.js"></script>
		<script src="/MicheleProject/components/vendor/owl.carousel/owl.carousel.min.js"></script>

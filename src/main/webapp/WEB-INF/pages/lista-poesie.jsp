...
<body>
	...
	<main id="main">
			...
			<section id="services" class="services">
				<div class="container">
					<div class="row">
						...
						<c:if test="${not empty pageContext.request.remoteUser}">	
							<div class="col-lg-2">
								<button type="button" data-toggle="modal" data-target="#popInsertPoesia" class="button">Inserisci</button>
							</div>
						</c:if>
					</div>
					<% int i = 1;%>
					<c:forEach var="item" items="${poesie}">
						<% if(i==1){%>
						<div class="row">
							<div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
								...
								<p class="description showContentAll displayreadallsome">${item.descrizione}</p>
								<p>
		...
		<div class="container">
			<!-- .modal -->
			<div class="modal fade" id="popInsertPoesia" role="dialog">
							        ...
							        <div class="row" data-aos="fade-in">
							          <div class="col-lg-12"> <!-- action="${url}" method="POST" -->
											<div class="form-group">
												...
												<input type="text"
													class="form-control" id="titoloPoesia"
											...
											<div class="form-group">
												...
												<input type="text"
													class="form-control" id="annoPubblicazioneP"
													data-rule="minlen:4" placeholder="Anno" data-msg="Inserisci l'anno per favore" />
												<div class="validate"></div>
											</div>
											<div class="form-group">
												<label for="Descrizione">Descrizione:</label>
												<textarea class="form-control" rows="10" id="descrizionePoesia"
		...
		<div class="container">
			...
			<div class="modal fade" id="popUpdate" role="dialog">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<section id="popUpdatePoesia" class="">
